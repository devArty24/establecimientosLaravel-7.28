<template>
    <div class="mapa">
        <l-map :zoom="zoom" :center="center" :options="mapOptions">
            ...
            <l-marker v-for="establecimiento in establecimientos" v-bind:key="establecimiento.id" :lat-lng="obtenerCordenadas(establecimiento)" :icon="iconoEstablecimientos(establecimiento)" @click="redireccionar(establecimiento.id)">
                <l-tooltip>
...
<script>
    ...
    export default {
        ...
        methods:{
            obtenerCordenadas(establecimiento){
                return {
                    lat: establecimiento.lat,
                    lng: establecimiento.lng
                }
            },
            iconoEstablecimientos(establecimiento){
